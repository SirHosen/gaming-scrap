...
from nestfetch.sites.registry import get_adapter, available_sites
...
def print_sites() -> None:
    ...
    for m in metas:
        ...
        try:
            ...
            # Non-fatal: just skip the extra detail lines for this site.
            log.debug("Could not introspect adapter %s: %s", m.name, exc)
    print()
...
def run_link_check(params: dict) -> dict:
    ...
    """
    from nestfetch.link_checker import check_csv_links
...
def _build_notifier(params: dict):
    ...
    from nestfetch.notifier import Notifier
    from nestfetch.settings import load_settings
...
def _run_watch(params: dict) -> None:
    ...
    from nestfetch.scheduler import run_scheduler
